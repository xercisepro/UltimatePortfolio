...
extension Sequence{
    /*sorted(by:) method rethrows, which means if areInIncreasingOrder is passed a throwing function then this sorted(by:) method
     also becomes a throwing function. On the other hand, if areInIncreasingOrder is not a throwing function then this
