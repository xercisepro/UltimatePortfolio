...
//
//  Created by Andrew CP Markham on 5/2/21.
//
...
class ExtensionTests: XCTestCase {
    ...
    func testSequenceKeyPathSortingSelf() {
        ...
        XCTAssertEqual(sortedItems, [1, 2, 3, 4, 5], "The sorted numbers must me ascending.")
    }
    ...
    func testDecodingDictionary() {
        ...
        XCTAssertEqual(data.count, 3, "There should be three items decoded from DecodableDictionary")
